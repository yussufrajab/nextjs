  ...
  const handleSearchRequests = () => {
    if (!zanIdInput.trim()) {
      toast({
        ...
        description: "Please enter an employee's ZanID to search.",
        variant: 'destructive',
      });
      return;
    }
        ...
        <Card className="shadow-lg mb-6">
          <CardHeader>
            ...
            <CardDescription>
              {isTableView
                ? role === ROLES.HRO
                  ? 'View all requests submitted within your institution. Use filters to refine the list.'
              ...
              <div className="flex flex-col sm:flex-row sm:items-end sm:space-x-2 space-y-2 sm:space-y-0">
                <div className="flex-grow space-y-1">
                  ...
                  <Input
                    ...
                    value={zanIdInput}
                    onChange={(e) => setZanIdInput(e.target.value)}
                    disabled={isSearching}
                  />
                </div>
                <Button
                  onClick={handleSearchRequests}
                  disabled={isSearching || !zanIdInput.trim()}
                >
                  {isSearching ? (
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  ) : (
            ...
            <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <CardTitle>
                  {isTableView
                    ? 'Requests List'
                    : `Request Status for ZanID: ${zanIdInput}`}
                </CardTitle>
                <CardDescription>
                  {isTableView &&
              ...
              {filteredRequests.length > 0 ? (
                  ...
                  <Table>
                    <TableCaption>
                      {isTableView
                        ...
                        : `A list of recent requests for ZanID: ${zanIdInput}.`}
                    </TableCaption>
                    <TableHeader>
                      <TableRow>
                ...
                <p className="text-muted-foreground text-center py-4">
                  {isTableView
                    ...
                    : `No requests found for ZanID: ${zanIdInput}.`}
                </p>
              )}
            </CardContent>
          </Card>
