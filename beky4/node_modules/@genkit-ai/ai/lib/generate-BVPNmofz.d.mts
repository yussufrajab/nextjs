import { z, JSONSchema7, ActionContext, Action, ActionRunOptions, DetachedAction, StreamingCallback, GenkitError, Operation } from '@genkit-ai/core';
import { Registry } from '@genkit-ai/core/registry';
import { b as DocumentData, l as ToolRequestPart, m as ToolResponsePart } from './document-DPYGNwPg.mjs';
import { GenerateResponseChunk } from './generate/chunk.mjs';
import { GenerateResponse } from './generate/response.mjs';
import { M as ModelArgument, c as ModelMiddleware } from './model-D5eses2k.mjs';
import { DynamicResourceAction } from './resource.mjs';
 ...
 */
type DynamicToolAction<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny> = DetachedAction<I, O, z.ZodTypeAny, ToolRunOptions> & Resumable<I, O> & {
    __action: {
        metadata: {
            type: 'tool';
        };
 ...
 */
type ToolArgument<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny> = string | ToolAction<I, O> | DynamicToolAction<I, O> | Action<I, O> | ExecutablePrompt<any, any, any>;
/**
...
declare function isDynamicTool(t: unknown): t is DynamicToolAction;
