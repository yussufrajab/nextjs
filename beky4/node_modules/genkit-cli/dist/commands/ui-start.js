...
const server_harness_1 = require("./server-harness");
...
async function startAndWaitUntilHealthy(port, serversDir) {
    return new Promise((resolve, reject) => {
        const child = (0, child_process_1.spawn)(process.execPath, [server_harness_1.SERVER_HARNESS_COMMAND, port.toString(), serversDir + '/devui.log'], {
