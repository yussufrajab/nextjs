  ...
  const runHRIMSTests = async () => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        const successCount =
          result.data.tests?.filter(
            (t: TestResult) => t && t.status === 'success'
          ).length || 0;
      ...
      toast({
        ...
        description:
          error instanceof Error ? error.message : 'Failed to run HRIMS tests',
        variant: 'destructive',
      });
    } finally {
      setIsRunning(false);
    ...
    <div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Choose which HRIMS API tests to execute. Run tests individually to
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex items-start space-x-3 p-3 border rounded-lg hover:bg-gray-50">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    RequestId: 202 - Fetch employee by payroll number
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 p-3 border rounded-lg hover:bg-gray-50">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    RequestId: 204 - Paginated fetch (can be slow)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 p-3 border rounded-lg hover:bg-gray-50">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    RequestId: 205 - Paginated fetch (can be slow)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 p-3 border rounded-lg hover:bg-gray-50 md:col-span-2 bg-amber-50 border-amber-300">
                ...
                <div className="flex-1">
                  <Label htmlFor="test5" className="font-medium cursor-pointer">
                    Test 5: Employee Documents (RequestId 206) - Multiple Calls
                    by Document Type (120s timeout)
                  </Label>
                  <p className="text-xs text-gray-500 mt-1">
                    Direct HRIMS API calls - HRIMS now splits documents by type
                    (Ardhilihal, Employment Contract, Birth Certificate,
                    Educational Certificate, Confirmation Letter) to reduce
                    payload. Each selected document type makes a separate API
                    call with 120s timeout to prevent timeouts.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t pt-4 mt-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  ...
                  className="text-xs"
                >
                  {parameters.selectedTests.length === 5
                    ? 'Deselect All'
                    : 'Select All'}
                </Button>
              </div>
            ...
            {parameters.selectedTests.length > 0 && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  <strong>{parameters.selectedTests.length}</strong> test
                  {parameters.selectedTests.length !== 1 ? 's' : ''} selected
                  {parameters.selectedTests.length > 1 && (
                    <span className="ml-2 text-blue-600">
                      • Tests will run sequentially with delays between them
                    </span>
                  )}
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setParameters({
                    ...parameters,
                    photoSearchCriteria: e.target.value,
                  })
                }
                placeholder="111660"
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setParameters({ ...parameters, voteCode: e.target.value })
                }
                placeholder="004"
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setParameters({ ...parameters, tinNumber: e.target.value })
                }
            ...
            <div className="space-y-2">
              <Label htmlFor="documentsSearchCriteria">
                Documents Search (Test 5)
              </Label>
              <Input
                ...
                onChange={(e) =>
                  setParameters({
                    ...parameters,
                    documentsSearchCriteria: e.target.value,
                  })
                }
                placeholder="149391"
              />
              ...
              <div className="mt-3 p-3 border rounded-lg bg-amber-50 border-amber-300">
                ...
                <p className="text-xs text-amber-700 mt-2">
                  HRIMS now splits documents by type to reduce payload and
                  prevent timeouts. Select which document types to fetch.
                </p>
              </div>
            </div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            These tests will verify connection to the HRIMS system and test data
        ...
        <CardContent>
          ...
          <div className="mt-4 text-sm text-gray-600">
            <p>
              <strong>Tests will verify:</strong>
            </p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>
                <strong>Test 1:</strong> Specific employee data fetching
                (RequestId: 202) - for payroll# {parameters.payrollNumber}
              </li>
              <li>
                <strong>Test 2:</strong> Employee photo fetching (RequestId:
                203) - for ID {parameters.photoSearchCriteria}
              </li>
              <li>
                <strong>Test 3:</strong> Employees by Vote Code (RequestId: 204)
                - paginated (page {parameters.pageNumber}, size{' '}
                {parameters.pageSize}) for votecode {parameters.voteCode}
              </li>
              <li>
                <strong>Test 4:</strong> Employees by TIN Number (RequestId:
                205) - paginated (page {parameters.pageNumber}, size{' '}
                {parameters.pageSize}) for TIN {parameters.tinNumber}
              </li>
              <li>
                <strong>Test 5:</strong> Employee documents fetching (RequestId:
                206) - Direct HRIMS API call for PayrollNumber{' '}
                {parameters.documentsSearchCriteria}. Fetches{' '}
                {parameters.selectedDocumentTypes.length} document type(s):{' '}
                {parameters.selectedDocumentTypes
                  .map((t) =>
                    t === '2'
                      ? 'Ardhilihal'
                      : t === '3'
                  ...
                  .join(', ')}
                . Each type uses 120s timeout.
              </li>
            </ul>
            <p className="mt-3 text-blue-700 font-medium">
              💡 Tests 3 & 4 include pagination metadata (overallDataSize,
              currentDataSize, currentPage) in the response.
            </p>
            <p className="mt-2 text-amber-700 font-medium">
              ⚠️ Test 5 makes direct HRIMS API calls to verify integration.
              HRIMS now splits documents by type (Ardhilihal, Employment
              Contract, Birth Certificate, Educational Certificate, Confirmation
              Letter) to reduce payload and prevent timeouts. Each selected
              document type makes a separate API call with 120s timeout. Note:
              The profile page works because it uses cached documents from
              MinIO.
            </p>
            <p className="mt-2 text-amber-700 text-xs">
              ⚠️ Use page size 10-20 for testing. Larger values may cause
              timeouts for institutions with many employees. The actual fetch
              operation will automatically loop through all pages.
            </p>
          </div>
        </CardContent>
      </Card>
                  ...
                  {(test as any).requestPayload && (
                    <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-3">
                      ...
                      <div className="text-sm space-y-2">
                        <p>
                          <strong>Endpoint:</strong> {(test as any).endpoint}
                        </p>
                        <div>
                          ...
                          {(test as any).responseInfo && (
                            <>
                              <p>
                                ...
                                {(test as any).responseInfo.status}{' '}
                                {(test as any).responseInfo.statusText}
                              </p>
                              <p>
                                <strong>Response Size:</strong>{' '}
                                {
                                  (test as any).responseInfo.dataStructure
                                    ?.responseSize
                                }{' '}
                                characters
                              </p>
                              <p>
                                ...
                                {(
                                  test as any
                                ).responseInfo.dataStructure?.dataKeys?.join(
                                  ', '
                                ) || 'None'}
                              </p>
                              {(test as any).responseInfo.dataStructure
                              ...
                              {(test as any).responseInfo.dataStructure
                                ...
                                <div className="border-t border-green-300 pt-2 mt-2">
                                  ...
                                  <p>
                                    <strong>Current Data Size:</strong>{' '}
                                    {
                                      (test as any).responseInfo.dataStructure
                                        .paginationInfo.currentDataSize
                                    }
                                  </p>
                                  <p>
                                    <strong>Overall Data Size:</strong>{' '}
                                    {
                                      (test as any).responseInfo.dataStructure
                                        .paginationInfo.overallDataSize
                                    }
                                  </p>
                                  {(test as any).responseInfo.dataStructure
                                    .paginationInfo.overallDataSize >
                                    ...
                                    <p className="text-blue-700 mt-1">
                                      💡 More pages available to fetch
                                    </p>
                                  )}
                                </div>
                              )}
                              {(test as any).responseInfo.dataStructure
                                ?.hasPhotoData !== undefined && (
                                <p>
                                  <strong>Has Photo Data:</strong>{' '}
                                  {(test as any).responseInfo.dataStructure
                                    .hasPhotoData
                                    ? 'Yes'
                                    : 'No'}
                              ...
                              {(test as any).responseInfo.dataStructure
                                ?.photoContentLength && (
                                <p>
                                  <strong>Photo Content Length:</strong>{' '}
                                  {
                                    (test as any).responseInfo.dataStructure
                                      .photoContentLength
                                  }{' '}
                  ...
                  {test.status === 'failed' && (
                    <div className="bg-red-50 border border-red-200 rounded p-3">
                      ...
                      <div className="text-sm space-y-2">
                        ...
                        {test.error?.status && (
                          <p>
                            <strong>Status:</strong> {test.error.status}{' '}
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="text-sm space-y-2">
            <p>
              <strong>If tests pass:</strong> The HRIMS integration is working
              correctly and you can proceed to use the "Fetch Data" feature.
            </p>
            <p>
              <strong>If tests fail with connection errors:</strong> Check if
              the HRIMS server at 10.0.217.11:8135 is accessible from your
              network.
            </p>
            <p>
              <strong>If tests fail with 401/403 errors:</strong> The API
              credentials may need to be updated.
            </p>
            <p>
              <strong>If tests fail with different response format:</strong> The
              HRIMS API structure may have changed from the documentation.
            </p>
          </div>
        </CardContent>
      </Card>
