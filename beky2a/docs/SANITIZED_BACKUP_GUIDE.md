...
**Location:** `/home/latest/beky2a/scripts/backup-database-no-employees.sh`
...
**Location:** `/home/latest/beky2a/scripts/restore-database-no-employees.sh`
...
Configuration:
  ...
  User:         postgres
  Database:     nody
  Output Dir:   /home/latest/beky2a/database
...
Summary:
  Database:     nody
  Location:     /home/latest/beky2a/database
  Timestamp:    20260113_195449
...
0 3 * * * cd /home/latest/beky2a/scripts && ./backup-database-no-employees.sh -W "PASSWORD" >> /var/log/sanitized-backup.log 2>&1
```
...
**Check backups:**
```bash
ls -lh /home/latest/beky2a/database/*no_employees*.sql
```

**View backup info:**
```bash
cat /home/latest/beky2a/database/*no_employees*_info.txt
```
...
**Scripts Location:** `/home/latest/beky2a/scripts/`
