...
| --------------------------- | ------- | ------------------------ | ---------------- |
| **CISO**                    | (Name)  | ciso@zanajira.go.tz      | +255 XX XXX XXXX |
| **System Administrator**    | (Name)  | admin@zanajira.go.tz     | +255 XX XXX XXXX |
| **Security Officer**        | (Name)  | security@.zanajira.go.tz | +255 XX XXX XXXX |
| **Data Protection Officer** | (Name)  | dpo@zanajira.go.tz       | +255 XX XXX XXXX |
| **Incident Response**       | (24/7)  | incident@zanajira.go.tz  | +255 XX XXX XXXX |
