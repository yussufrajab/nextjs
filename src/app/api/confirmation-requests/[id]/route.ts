...
export const PUT = wrapHandler(handleUpdate, 'confirmation-requests');
export const PATCH = wrapHandler(handleUpdate, 'confirmation-requests');
...
}, 'confirmation-requests-withdraw');
