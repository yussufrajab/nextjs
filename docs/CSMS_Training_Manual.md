...
- ✅ **Accuracy:** Reduced errors through validation
- ✅ **Security:** Role-based access and complete audit trail
- ✅ **Accessibility:** 24/7 web access from anywhere
...
```
┌─────────────────────────────────────────────────────┐
│  CSMS Logo    [Dashboard] [Employees] [Requests]    │
│               [Language: EN/SW]  [User: John] [🔔]  │
├─────────────────────────────────────────────────────┤
│                                                     │
│  Welcome, John Doe (HR Officer)                     │
│                                                     │
│  ┌────────────┐  ┌────────────┐  ┌────────────┐   │
│  │ Pending    │  │ Approved   │  │ Rejected   │   │
│  │ Requests   │  │ This Month │  │ This Month │   │
│  │    12      │  │     45     │  │     3      │   │
│  └────────────┘  └────────────┘  └────────────┘   │
│                                                     │
│  Recent Activities                                  │
...
│                                                     │
│  Quick Actions                                      │
│  [Submit Request] [Search Employee] [View Reports] │
│                                                     │
└─────────────────────────────────────────────────────┘
```
...
1. Click **"Requests"** → **"Confirmation"** → **"New Request"**
...
Probation Period: 24 months ✅ (Eligible)
Status: On Probation
...
1. Click **"Requests"** → **"Promotion"** → **"New Request"**
...
1. Click **"Requests"** → **"LWOP"** → **"New Request"**
...
3. **Fill LWOP Details:**
   ...
   - Loan Guarantee Confirmation: ☑ (checkbox - REQUIRED)
   - Comments (optional)
...
5. **Review:**
   - System validates:
     ...
     ✅ LWOP count (max 2)
     ✅ Prohibited reason keywords
     ✅ Loan guarantee confirmed
...
Bad LWOP Reason :
"Employee's spouse relocated to another country" ❌
```
...
1. Click **"Requests"** → **"Retirement"** → **"New Request"**
...
- ✅ Monitor workload and SLA compliance
...
1. Click **"Requests"** → **"Pending Approvals"**
...
1. Click **"Complaints"** → **"Pending Complaints"**
...
- ✅ Employment details
- ✅ Current status
- ✅ Documents (Ardhilhali, certificates)
- ✅ Employment history
...
1. Click **"Admin"** → **"User Management"** → **"Create User"**
...
1. Click **"Admin"** → **"Institutions"** → **"Create Institution"**
...
1. **Google Chrome 90+** ⭐ (Best performance)
