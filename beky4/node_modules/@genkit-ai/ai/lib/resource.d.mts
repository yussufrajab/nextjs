import { DetachedAction, z, ActionContext, Action } from '@genkit-ai/core';
 ...
 */
type DynamicResourceAction = DetachedAction<typeof ResourceInputSchema, typeof ResourceOutputSchema> & {
    __action: {
        metadata: {
            type: 'resource';
        };
...
declare function isDynamicResourceAction(t: unknown): t is DynamicResourceAction;
/**
 * Defines a dynamic resource. Dynamic resources are just like regular resources but will not be
 * registered in the Genkit registry and can be defined dynamically at runtime.
 */
...
export { type DynamicResourceAction, type ResourceAction, type ResourceFn, type ResourceInput, ResourceInputSchema, type ResourceOptions, type ResourceOutput, ResourceOutputSchema, defineResource, dynamicResource, findMatchingResource, isDynamicResourceAction };
