...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    roles: [ROLES.HRO, ROLES.HRRP, ROLES.HRO_PEMBA, ROLES.HRRP_PEMBA],
    icon: AlertTriangle,
  ...
  },
  {
    ...
    roles: [ROLES.HRO, ROLES.HRO_PEMBA],
    icon: UserPlus,
  ...
  },
  {
    ...
    icon: UserCheck,
    roles: [ROLES.HRO, ROLES.HHRMD, ROLES.HRMO, ROLES.CSCS, ROLES.HRRP, ROLES.HRO_PEMBA, ROLES.HRRP_PEMBA],
  ...
  },
  {
    ...
    icon: ShieldAlert,
    roles: [ROLES.HRO, ROLES.DO, ROLES.HHRMD, ROLES.CSCS, ROLES.HRRP, ROLES.HRO_PEMBA, ROLES.HRRP_PEMBA],
    description:
